...
class AIModelConfigPage extends StatefulWidget {
  const AIModelConfigPage({super.key});

  @override
  State<AIModelConfigPage> createState() => _AIModelConfigPageState();
}

class _AIModelConfigPageState extends State<AIModelConfigPage> {
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              validator: (value) {
                                ...
                                if (!HuggingFaceTokenService.isValidTokenFormat(
                                  value,
                                )) {
                                  return 'Token 格式不正确';
                                }
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              validator: (value) {
                                ...
                                if (!BlueLMConfigService.isValidAppIdFormat(
                                  value,
                                )) {
                                  return 'App ID 不能为空';
                                }
                            ...
                            TextFormField(
                              ...
                              validator: (value) {
                                ...
                                if (!BlueLMConfigService.isValidAppKeyFormat(
                                  value,
                                )) {
                                  return 'App Key 不能为空';
                                }
